	...
	<div class="container-fluid">
		<div class="row col-md-6 mx-auto my-5">
			<div class="form-check">
				...
				<label class="form-check-label"for="flexCheckDefault"> 전체동의 </label>
			</div>
			<div class="form-check">
				<input class="form-check-input checks" type="checkbox" value=""id="check1"> 
				<label class="form-check-label"for="flexCheckChecked"> 동의1 </label>
			<div class="form-check">
				<input class="form-check-input checks" type="checkbox" value=""id="check2"> 
				<label class="form-check-label"for="flexCheckDefault"> 동의2 </label>
			</div>
			<div class="form-check">
				<input class="form-check-input checks" type="checkbox" value=""id="check3"> 
				<label class="form-check-label" for="flexCheckChecked"> 동의3 </label>
			</div>
